 ...
 */
final class Version20210930120057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE persona_fisica (id INT NOT NULL, sexo_id INT NOT NULL, autopercibido_id INT DEFAULT NULL, estado_civil_id INT DEFAULT NULL, nacionalidad_id INT NOT NULL, apellido VARCHAR(255) NOT NULL, nombres VARCHAR(255) NOT NULL, nro_doc VARCHAR(255) NOT NULL, cuit_cuil INT NOT NULL, fecha_nac DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE sexo (id INT NOT NULL, sexo VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
